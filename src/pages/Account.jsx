...
export default function Account() {
  ...
  useEffect(() => {
    ...
    setAvatarStyle(profile?.avatar_style || 'notionists');
  ...
  const handleAvatarSave = async () => {
    ...
    const { error } = await supabase
      .from('user_profiles')
      .update({ avatar_style: avatarStyle, avatar_seed: avatarSeed })
      .eq('id', user.id);
      ...
      <div className="flex-grow-1 overflow-auto py-5 px-3">
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <div className="glass-panel p-4 mb-4 position-relative overflow-hidden">
            ...
            <div style={{ position: 'absolute', right: -40, bottom: -40, opacity: 0.03, pointerEvents: 'none' }}>
              <User size={300} />
            </div>
          </div>
          ...
          {/* Avatar Editor */}
          {showAvatarEditor && (
            <div className="glass-panel p-4 mb-4 animate-fade-in border-primary shadow-lg" style={{ border: '1px solid var(--system-blue)' }}>
              ...
              <div className="row g-3 mb-4">
                {[
                  { id: 'notionists', label: 'Artistic' },
                  { id: 'avataaars',  label: 'Modern' },
                  { id: 'pixel-art',  label: 'Pixel' },
                  { id: 'bottts',     label: 'Robotic' },
              ...
              <div className="mt-3 text-center">
                <small className="text-muted">Previewing: <b>{avatarStyle}</b> Style</small>
              </div>
            </div>
          )}
